...
import { resolveBackendAssetUrl } from '@/shared/lib/resolveBackendAssetUrl';
...
export default function ProfileImageUploader({
  ...
  useEffect(() => {
    if (!initialImageUrl || previewUrl) return;
    const resolved = resolveBackendAssetUrl(initialImageUrl);
